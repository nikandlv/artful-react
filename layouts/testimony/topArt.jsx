export default function TopArt() {
    return (
        <svg className="top-art" xmlns="http://www.w3.org/2000/svg" width="394" height="524" viewBox="0 0 394 524">
        <defs>
            <clipPath id="cliath">
            <rect id="Rectangle_74" data-name="Rectangle 74" width="394" height="524" transform="translate(1046 1348)" fill="#fff" stroke="#707070" strokeWidth="1"/>
            </clipPath>
        </defs>
        <g id="Mask_Group_2" data-name="Mask Group 2" transform="translate(-1046 -1348)" clipPath="url(#cliath)">
